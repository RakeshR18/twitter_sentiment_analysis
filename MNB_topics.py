...
dataset.drop(['instance_number','sentiment','is_sarcastic'],axis=1,inplace = True)
text_data = dataset['tweet_text']
topic_id = dataset['topic_id']
x_train, x_test, y_train, y_test = train_test_split(text_data,topic_id,test_size = 0.25, random_state = 0)
